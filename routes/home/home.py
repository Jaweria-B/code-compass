...
def home_page():
    ...
    # Adding a header
    st.header("What technology do you want to learn today?")

    # Adding a text input field for the user to enter the desired technology
    topic = st.text_input("Enter the technology you want to learn:", "")
